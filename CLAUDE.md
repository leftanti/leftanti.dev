...
Task-level requirements live in [BUILD_PROMPT.md](BUILD_PROMPT.md). **This file holds only the rules that must hold on every future change.** When the two disagree, BUILD_PROMPT.md wins on *what to build*; this file wins on *how*.
